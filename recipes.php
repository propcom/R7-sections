...
<div class="recipes">
    <div class="centre-wrap">
        ...
        <a href="" class="button__button  button__button--menu  button__button--trigger  js-recipes-trigger">
            Pie Recipes and Cooking Methods
        </a>
            ...
            <div class="menu">
                ...
                <nav class="menu__nav">
                    ...
                    <? foreach ($menu_group->menu_options_urls as $url => $title) : ?>
                        ...
                        <? if (is_numeric($url)) : ?>
                            <a class="<?= $class; ?> <?= ($i + 1) % 3 === 0 ? 'last ' : ''; ?><?= $c >= 3 ? 'float ' : ''; ?>button__button  button__button--menu<?= $i === 0 ? ' active' : '' ?>"
                               href="javascript:void(0);"><?= $title ?></a>
                        <? else : ?>
                            <a class="<?= ($i + 1) % 3 === 0 ? 'last ' : ''; ?><?= $c >= 3 ? 'float ' : ''; ?>button__button  button__button--menu pdf"
